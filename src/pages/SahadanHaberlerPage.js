...
export default function SahadanHaberlerPage() {
    ...
    const fetchNews = async () => {
        try {
            setLoading(true);
            const response = await axios.get('/api/saha-news/');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            setSubmitting(true);
            const response = await axios.post('/api/saha-news/', {
                content: newPost
            });
    ...
    const handleDelete = async (newsId) => {
        ...
        try {
            await axios.delete(`/api/saha-news/${newsId}/`);
    ...
    return (
        <div className="sahadan-haberler-page" style={{ 
            minHeight: '100vh',
            paddingTop: '80px',
                    ...
                    <div style={{
                        ...
                        <form onSubmit={handleSubmit}>
                            <textarea
                                ...
                                placeholder="SaHa'dan yeni bir haber paylaşın..."
                                style={{
                                    width: '100%',
                                    minHeight: '100px',
                                    padding: '1rem',
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    background: submitting || !newPost.trim() ? '#ccc' : '#14b8a6',
                                    color: 'white',
                                    border: 'none',
                                    borderRadius: '8px',
                                    fontSize: '1rem',
